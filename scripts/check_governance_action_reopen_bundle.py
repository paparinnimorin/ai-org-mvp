...
def main() -> int:
    p = argparse.ArgumentParser(description="Check governance action reopen bundle.")
    ...
    p.add_argument("--process", default="docs/process/governance-action-reopen.md")
    p.add_argument("--checklist", default="docs/checklists/governance-action-reopen-checklist.md")
    ...
    if process_file.exists():
        print(f"[OK] reopen process found: {process_file}")
    else:
        print(f"[NG] reopen process missing: {process_file}")
        ok = False

    if checklist_file.exists():
        print(f"[OK] reopen checklist found: {checklist_file}")
    else:
        print(f"[NG] reopen checklist missing: {checklist_file}")
        ok = False
